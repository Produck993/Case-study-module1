...
function update() {
    ...
    ctx.fillText("Score :"+ scrore, 400 , 50);
...
function reset() {
    ctx.font = "30px iciel Cadena";
    ctx.fillStyle = "red";
    ctx.textAlign = "right !==0";
    let highscore = localStorage.setItem('highscore',scrore);
    let high = localStorage.getItem('highscore')
    console.log('Điểm lớn nhất :' + high)
     document.getElementById('best1').innerHTML = "ĐIỂM LỚN NHẤT MÀN CHƠI TRƯỚC:" +high ; 
